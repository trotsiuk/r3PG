...
logical :: thin_defol_stress_cor = .TRUE.                 ! update dbh and basal_area before self-thinning calculations if there was thinning, defoliation or stress-related mortality
