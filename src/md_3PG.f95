...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            !if ( sum(stems_loss_manag(:) + stems_loss_def(:) + stems_loss_stress(:)) > 1.0e-6 ) then
            if ( any(stems_loss_density(:) > 1.0e-6) ) then
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                biom_tree(:) = biom_stem(:) * 1000.d0 / stems_n(:)  ! kg/tree
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine s_sizeDist_correct2 (n_sp, age, stems_n, biom_tree, competition_total, lai, &
        height_model, pars_s, pars_b, aWs, nWs, pfsPower, pfsConst, & ! removed correct_bias
        dbh, basal_area, height, crown_length, crown_width, pFS, bias_scale)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    end subroutine s_sizeDist_correct2
