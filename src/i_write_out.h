...
!!!!!1output(ii,:,10,5) = bias_scale(5,:)
!!!!!1output(ii,:,10,6) = bias_scale(6,:)
!!!!!1output(ii,:,10,7) = bias_scale(7,:)
!!!!!1output(ii,:,10,8) = bias_scale(8,:)
!!!!!1output(ii,:,10,9) = bias_scale(9,:)
!!!!!1output(ii,:,10,10) = bias_scale(10,:)
!!!!!1output(ii,:,10,11) = bias_scale(11,:)
!!!!!1output(ii,:,10,12) = bias_scale(12,:)
!!!!!1output(ii,:,10,13) = bias_scale(13,:)
!!!!!1output(ii,:,10,14) = bias_scale(14,:)
