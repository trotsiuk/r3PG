...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
output(ii,:,10,8) = leafgrow(:)
output(ii,:,10,9) = prop_carbs(:)
output(ii,:,10,10) = biom_foliage_adj_pre_def(:)
output(ii,:,10,11) = def_recover_t(:)
output(ii,:,10,12) = growing_season_length(:)
output(ii,:,10,13) = npp_fract_stem(:)
output(ii,:,10,14) = pFS(:)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
