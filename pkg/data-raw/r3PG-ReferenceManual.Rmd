...
# Three case studies with 3PG

For the following case studies, we will be using freely available forest growth data from the [PROFOUND database](https://doi.org/10.5194/essd-2019-220). There is an R package available that allows accessing the database (which is in sql format) conventiently from R. 
...
r3pg_ll <- function( pars ){
  ...
  sim.df <- f_3PG(
    ...
    sizeDistInputs = matrix(NA_real_, nrow = 30, ncol = 2 ),
    n_sp = 1L, n_m = 564L, n_man = 14L, t_t = 14L, 
