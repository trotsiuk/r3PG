...
test_that("prepare_site validates altitude range", {
  d_site <- data.frame(
    latitude = 46.8,
    altitude = 5000, # Invalid
    soil_class = 2,
    asw_i = 150,
    asw_min = 100,
    asw_max = 200,
  ...
  expect_error( prepare_site(d_site), regexp = "Altitude must be within the range \\[0, 4000\\].")
})
